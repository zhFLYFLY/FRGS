...
# ============ 添加从这里开始 ============
# 设置日志目录为指定路径
log_base_dir = "/home/zhouhuan/project/CityNavAgent/CityNavAgent-main/output/"
# 创建日志目录结构
log_dir = os.path.join(log_base_dir, "logs", args.name, args.run_type)
os.makedirs(log_dir, exist_ok=True)
# 设置日志文件路径
args.logger_file_name = os.path.join(log_dir, f"{args.name}_{args.make_dir_time}.log")
# ============ 添加到这里结束 ============
